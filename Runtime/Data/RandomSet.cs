...
namespace HFHandyUtils.Data
{
    public static class GlobalRandom
    {
        ...
        /// <summary>
        ///     Reference to properly invoke OnGlobalSeedChanged
        /// </summary>
        ...
        /// <summary>
        ///     Sets the global seed. Should be called after awake
        /// </summary>
        ...
        /// <summary>
        ///     Pulls a random number based on date time
        /// </summary>
        ...
        /// <summary>
        ///     Quick log statement for debugging generic random sets
        /// </summary>
                            ...
                            IFormattable
    {
        ...
        public void Terminate()
        {
            ...
            if (!_initialized)
            {
                GlobalRandom.LogError(typeof(TNumeric), _name, $"Attempted a double termingation of {_name}");
                return;
            }
        ...
        /// <summary>
        ///     Fills the set with a cache of random values we can pull from
        /// </summary>
        ...
        /// <summary>
        ///     Interprets the processing type that the generic random set will use
        /// </summary>
        ...
        #region Pull Random
        /// <summary>
        ///     Gets a random value between Type Minimum and Type Maximum
        /// </summary>
